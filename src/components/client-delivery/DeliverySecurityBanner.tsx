  ...
  return (
    <div className="bg-charcoal text-white rounded-custom p-4 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border border-primary/40">
      <div className="flex items-start gap-2.5">
        <Lock size={16} className="text-white/60 shrink-0 mt-0.5" />
        <div className="text-xs">
          <span className="font-bold tracking-wider uppercase block text-white/90">
      ...
      <div className="text-[10px] uppercase font-bold tracking-widest text-white/40 bg-white/10 px-3 py-1 rounded-sm border border-white/20 font-mono shrink-0">
